    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-12">
                <h4 class="font-rubik font-size-20">Jixone Shop</h4>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyright 2023. Design By <a href="https://jasmeetsethi.netlify.app/" class="color-second">Jasmeet Sethi</a></p>
</div>
<!-- !start #footer -->
